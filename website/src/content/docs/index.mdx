...
description: Automatic Divi page translation for Claude Desktop. Preserves all [et_*] shortcodes and HTML structure during translation.
template: splash
hero:
  title: Divi Translator MCP
  tagline: Translate Divi pages from Claude Desktop. Shortcodes stay intact. HTML structure stays intact. Only the text changes.
  image:
...
- [Claude Desktop](https://claude.ai/download) (any plan)
...
<Aside type="note">
  This server implements the Model Context Protocol specification dated 2025-11-25. It communicates with Claude Desktop over standard input/output (stdio transport).
</Aside>
